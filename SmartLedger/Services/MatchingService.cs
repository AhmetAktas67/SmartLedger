...
namespace SmartLedger.Services
{
    public class MatchingService
    {
        ...
        // <== GEÄNDERT: kein "int jahr"-Parameter mehr
        public int WendeMatchesAn(List<MatchErgebnis> matches, BeitragszahlungRepository beitragsRepository)
        {
            int angewendet = 0;
            foreach (var match in matches)
            {
                ...
                int jahr = match.Buchung.BuchungsDatum.Year; // <== NEU: Jahr direkt aus der Buchung, nicht mehr von außen
